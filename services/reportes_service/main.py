...
# --- CORRECCIÓN: Variable Global para el Pool ---
pool = None

@app.on_event("startup")
async def startup_db():
    global pool
    # Creamos el pool una sola vez al iniciar
...
# Rutas de exportación se mantienen igual, solo cambia el uso de pool
    ...
    try:
        ...
        if report_type == "equipos":
            ...
            headers = ['Código', 'Nombre', 'Categoría', 'Estado', 'Ubicación']
             ...
             # Fallback simple para otros reportes en PDF por brevedad
             query = "SELECT codigo_inventario, nombre FROM equipos LIMIT 10"
